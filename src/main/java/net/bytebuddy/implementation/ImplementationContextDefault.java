 ...
 */
public class ImplementationContextDefault extends Implementation.Context.Default {
     ...
     */
    public ImplementationContextDefault(TypeDescription instrumentedType, ClassFileVersion classFileVersion, AuxiliaryType.NamingStrategy auxiliaryTypeNamingStrategy, TypeInitializer typeInitializer, ClassFileVersion auxiliaryClassFileVersion, FrameGeneration frameGeneration, String suffix) {
